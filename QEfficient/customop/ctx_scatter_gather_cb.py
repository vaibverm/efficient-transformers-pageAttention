...
@onnxscript.script(onnxscript.values.Opset("com.qualcomm.cloud", 1))
def CtxScatterPagedAttentionCB(
...
class CtxScatterFuncPagedAttentionCB(torch.autograd.Function):
    """
    ...
    def symbolic(
        ...
        return g.onnxscript_op(CtxScatterPagedAttentionCB, data, block_index, position_ids, updates).setTypeAs(data)
